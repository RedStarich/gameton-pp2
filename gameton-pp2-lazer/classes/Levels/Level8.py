...
class Level8(GameMap):
  ...
  def add_collisions(self, is_candle_available):
    ...
    self.add_collision("assets\students\student_3_bottom.png", 12.5 * TILE_SIZE, 10.25 * TILE_SIZE, "student")
    self.add_collision("assets\students\student_1_top_left.png", 19.25 * TILE_SIZE, 15.75 * TILE_SIZE, "student")
    self.add_collision("assets\students\student_1_right.png", 11.25 * TILE_SIZE, 21 * TILE_SIZE, "student")

    if is_candle_available:
      self.add_collision("assets\candles\candle_2.png", 24 * TILE_SIZE, 15.75 * TILE_SIZE, "candle")
