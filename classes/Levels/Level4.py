...
class Level4(GameMap):
  ...
  def add_collisions(self, is_candle_available):
    ...
    self.add_collision("assets\students\student_1_bottom.png", 10 * TILE_SIZE, 10 * TILE_SIZE, "student")
    self.add_collision("assets\students\student_1_top_left.png", 21.5 * TILE_SIZE, 12 * TILE_SIZE, "student")
    self.add_collision("assets\students\student_1_bottom_right.png", 21 * TILE_SIZE, 8 * TILE_SIZE, "student")
    self.add_collision("assets\students\student_1_top.png", 13.5 * TILE_SIZE, 19 * TILE_SIZE, "student")
    self.add_collision("assets\students\student_2_bottom.png", 17.5 * TILE_SIZE, 5 * TILE_SIZE, "student")

    if is_candle_available:
      self.add_collision("assets\candles\candle_3.png", 21.2 * TILE_SIZE, 5.5 * TILE_SIZE, "candle")
